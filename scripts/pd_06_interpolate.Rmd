...
```{r}
writeRaster(pd_krig_pred, "../data/pd_krig_pred.tif")
writeRaster(pd_krig_prb_std, "../data/pd_krig_prb_std.tif")
```
...
```{r}
writeRaster(x = pd_krig_prb_std, filename = "../outputs/krgd_ml_prb5_stdrsmp.tif")

writeRaster(x = pd_krig_pred, filename = "../outputs/krgd_ml_pred5_rsmp.tif")

writeRaster(x = pd_pred, filename = "../outputs/pd_enskrg_uk1bml2.tif")
```
