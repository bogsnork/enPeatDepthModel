...
```{r}
output <- raster::predict(predictors, Mlm2a, type="raw", progress="text",
                          response = "vote", index = 2)
writeRaster(x = output, filename = "../outputs/pd_lm_mod2a.tif")
plot(output)

output <- raster::predict(predictors, Mrf2a, type="raw", progress="text",
                          response = "vote", index = 2)
writeRaster(x = output, filename = "../outputs/pd_rf_mod2a.tif")
plot(output)
```
