...
```{r}
# output <- raster::predict(predictors, M.rf.8a.final, type="prob", progress="text", 
#                           response = "vote", index = 2)
# writeRaster(x = output, filename = "../outputs/BlanketBogRFModel8a.tif")
# plot(output)
# 
# output <- raster::predict(predictors, M.rf.8c.final, type="prob", progress="text", 
#                           response = "vote", index = 2)
# writeRaster(x = output, filename = "../outputs/BlanketBogRFModel8c.tif")
# plot(output)
# 
# output <- raster::predict(predictors, M.rf.8d.final, type="prob", progress="text", 
#                           response = "vote", index = 2)
# writeRaster(x = output, filename = "../outputs/BlanketBogRFModel8d.tif")
# plot(output)
```
